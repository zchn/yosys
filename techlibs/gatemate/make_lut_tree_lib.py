...
lut_prims = {
    ...
    "CC_L2T4": LUT2(
        "INIT_L10",
        LUT2("INIT_L00", I("D0A"), I("D1A")),
        LUT2("INIT_L01", I("D2A"), I("D3A")),
    ),
    "CC_L2T5": LUT2(
        "INIT_L20", I("D0"), LUT2("INIT_L11",
            LUT2("INIT_L02", I("D0B"), I("D1B")),
            LUT2("INIT_L03", I("D2B"), I("D3B")),
        )
    )
}
